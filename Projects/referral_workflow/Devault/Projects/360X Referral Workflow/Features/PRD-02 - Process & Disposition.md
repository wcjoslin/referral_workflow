---
up: "[[📋 PRD Index]]"
prev: "[[PRD-01 - Receive & Acknowledge]]"
next: "[[PRD-03 - Schedule Patient]]"
---
...
This document outlines the second major workflow in the 360X Closed Loop Referral process: the processing and disposition of an inbound referral. After a referral has been successfully received and acknowledged (as described in [[PRD-01 - Receive & Acknowledge|PRD-01]]), the receiving provider's clinical team must review the referral package to determine if they can accept the patient.
...
This workflow aims to equip clinicians with the necessary information, extracted from the referral C-CDA, to make an informed disposition decision, and automatically decline a referral if the C-CDA does not contain all required sections. The system will then generate and transmit the appropriate 360X-compliant message to inform the referring provider of the outcome.
...
### As a Clinician, I want to review a summary of a valid referral...
...
### As a Clinician, I want to accept or decline the referral...
...
### As a System, I want to inform the referring provider of the disposition...
...
### As a System, I want to automatically decline a referral if incomplete...
...
### Disposition Message (HL7 V2 RRI^I12)
...
- The state for the specific referral ID must transition from `Acknowledged` to `Accepted` or `Declined`
...
- [[PRD-01 - Receive & Acknowledge|Previous: PRD-01]]
- [[PRD-03 - Schedule Patient|Next: PRD-03]]
