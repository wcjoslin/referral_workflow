---
up: "[[📋 PRD Index]]"
prev: "[[PRD-02 - Process & Disposition]]"
next: ["[[PRD-04 - Generate Consult Note]]", "[[PRD-05 - Patient Encounter]]"]
---
...
Following a successful "Accept" disposition in [[PRD-02 - Process & Disposition|PRD-02]], the patient is now in the receiving provider's system and needs to be scheduled for an appointment. This workflow is the critical "next step" that moves the patient from a waiting list to a confirmed visit.
...
- [[PRD-02 - Process & Disposition|Previous: PRD-02]]
- [[PRD-04 - Generate Consult Note|Next: PRD-04]]
